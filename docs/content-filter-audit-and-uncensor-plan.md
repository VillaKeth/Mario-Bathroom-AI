...
**Purpose:** Hand this to another AI instance (or future me) to discuss/execute removing the content-censorship layers from the Mario AI party bot, so the character can be fully dynamic. Written to be self-contained — no prior chat context needed.
