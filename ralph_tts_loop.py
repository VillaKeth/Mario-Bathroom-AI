...
TEST_PHRASES = [
    ...
    ("Take-a care!", "Mama mia, take a care!"),
    ...
    ("Okie dokie!", "Mama mia, okey dokey!"),
    ...
    ("Splish splash, bathroom fun!", "Mama mia, bathroom fun!"),
    ("Tick tock tick tock, hurry up!", "Mama mia, hurry up!"),
    ...
    ("YAAAAYYYY! I won!", "Mama mia, yay! I won!"),
    ("Nooooooo! Bowser got me!", "Oh, no! Bowser got me!"),
    ("Wahoooooo! Let's go!", "Mama mia, let's go!"),
    ("BAAAAAALLS of fire!", "Mama mia, balls of fire!"),
    ...
    ("Wait... really?!", "Mama mia, wait, really?!"),
