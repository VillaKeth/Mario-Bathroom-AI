    ...
    def to_html(self) -> str:
        ...
        if data["birthday_person_interactions"]:
            ...
            vip_html = (
                ...
                f'<p>Mario chatted with them <b>{vip["interaction_count"]}</b> times!</p></div>'
            )
...
<title>Mario AI — Party Report Card</title>
<style>
...
<div class="footer">Generated by Mario AI Party Bot 🎮</div>
</div>
</body>
</html>"""
